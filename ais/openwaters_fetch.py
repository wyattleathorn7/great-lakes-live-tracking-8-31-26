...
def build_kml():
    ...
    kml_lines.append('  <Style id="vesselActive"><IconStyle><scale>0.8</scale><Icon><href>icons/Copilot_20260827_201004.png</href></Icon><hotSpot x="0.5" y="0.5" xunits="fraction" yunits="fraction"/></IconStyle><LabelStyle><scale>0.7</scale></LabelStyle><BalloonStyle><text><![CDATA[$[description]]]></text></BalloonStyle></Style>')
    kml_lines.append('  <Style id="vesselOffline"><IconStyle><color>ff808080</color><scale>0.7</scale><Icon><href>icons/Copilot_20260827_201004.png</href></Icon></IconStyle><LabelStyle><scale>0.6</scale></LabelStyle></Style>')
    for mmsi in sorted(roster_mmsi_set):
        ...
        if is_live:
            ...
            if icon_h is not None:
                kml_lines.append(f'    <Style><IconStyle><heading>{icon_h}</heading><Icon><href>icons/Copilot_20260827_201004.png</href></Icon></IconStyle></Style>')
